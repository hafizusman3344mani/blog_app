...
import 'package:blog_app/features/blogs/data/datasource/blog_data_source_impl.dart';
...
import '../../features/blogs/data/datasource/blog_data_source.dart';
...
Future<void> initDependencies() async {
  ...
  sl
    ...
    ..registerFactory<BlogRepository>(
        () => BlogRepositoryImpl(blogDataSource: sl()))
